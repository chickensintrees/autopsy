...
echo ""
echo "Optional — enforce the banner relay with a Stop hook (CLI/desktop):"
echo "  $PY $SCRIPT_DIR/hooks/enable.py         # idempotent, backs up settings.json"
echo "  $PY $SCRIPT_DIR/hooks/enable.py --dry-run   # preview the change first"
